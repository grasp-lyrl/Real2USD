            ...
            rows.append(
                {
                    ...
                    "sensor_source": m["metadata"].get("sensor_source", "unknown"),
                    ...
                    "mean_strict_accuracy_per_class": m["benchmark_compat"].get("mean_strict_accuracy_per_class"),
                    "mean_relaxed_accuracy_per_class": m["benchmark_compat"].get("mean_relaxed_accuracy_per_class"),
                    "mean_iou_3d_per_class": m["benchmark_compat"].get("mean_iou_3d_per_class"),
                    "mean_centroid_error_m_per_class": m["benchmark_compat"].get("mean_centroid_error_m_per_class"),
                    ...
                    "near_recall": m.get("range_metrics", {}).get("buckets", {}).get("near", {}).get("recall"),
                    "mid_recall": m.get("range_metrics", {}).get("buckets", {}).get("mid", {}).get("recall"),
                    "far_recall": m.get("range_metrics", {}).get("buckets", {}).get("far", {}).get("recall"),
                    "near_f1": m.get("range_metrics", {}).get("buckets", {}).get("near", {}).get("f1"),
                    "mid_f1": m.get("range_metrics", {}).get("buckets", {}).get("mid", {}).get("f1"),
                    "far_f1": m.get("range_metrics", {}).get("buckets", {}).get("far", {}).get("f1"),
                    "near_mean_iou_3d": m.get("range_metrics", {}).get("buckets", {}).get("near", {}).get("mean_iou_3d"),
                    "mid_mean_iou_3d": m.get("range_metrics", {}).get("buckets", {}).get("mid", {}).get("mean_iou_3d"),
                    "far_mean_iou_3d": m.get("range_metrics", {}).get("buckets", {}).get("far", {}).get("mean_iou_3d"),
            ...
            out.append(
                {
                    ...
                    "strict_accuracy": m.get("strict_accuracy"),
                    "relaxed_accuracy": m.get("relaxed_accuracy"),
                    "mean_centroid_error_m": m.get("mean_centroid_error_m"),
